...
public class Contraption : WPFMonoBehaviour
{
    ...
    public void StartContraption()
    {
        ...
        string header = "#include <vector>\n\nclass vector3_t\n{\npublic:\n  float x, y, z;\n};\n\nclass quaternion_t\n{\npublic:\n  float w, x, y, z;\n};\n\nclass transform_t\n{\npublic:\n  vector3_t local_position;\n  quaternion_t local_rotation;\n  vector3_t local_scale;\n};\n\nclass sphere_collider_t\n{\npublic:\n  bool value_set;\n  vector3_t center;\n  float radius;\n};\n\nclass capsule_collider_t\n{\npublic:\n  bool value_set;\n  vector3_t center;\n  float radius;\n  float hight;\n  int direction;\n};\n\nclass box_collider_t\n{\npublic:\n  bool value_set;\n  vector3_t center;\n  vector3_t size;\n};\n\nclass physic_material_t\n{\npublic:\n  bool value_set;\n  enum physic_material_combine_t\n  {\n    average = 0,\n    minimum = 1,\n    multiply = 2,\n    maximum = 3\n  };\n  float bounciness;\n  float dynamic_friction;\n  float static_friction;\n  int friction_combine;\n  int bounce_combine;\n};\n\nclass rigidbody_t\n{\npublic:\n  bool value_set;\n  enum rigidbody_constraints_t\n  {\n    none = 0,\n    freeze_position_x = 2,\n    freeze_position_y = 4,\n    freeze_position_z = 8,\n    freeze_rotation_x = 0x10,\n    freeze_rotation_y = 0x20,\n    freeze_rotation_z = 0x40,\n    freeze_position = 14,\n    freeze_rotation = 112,\n    freeze_all = 126\n  };\n  enum collision_detection_mode_t\n  {\n    discrete,\n    continuous,\n    continuous_dynamic,\n    continuous_speculative\n  };\n  enum rigidbody_interpolation_t\n  {\n    none,\n    interpolate,\n    extrapolate\n  };\n  vector3_t velocity;\n  vector3_t angular_velocity;\n  float drag;\n  float angular_drag;\n  float mass;\n  bool use_gravity;\n  float max_depenetration_velocity;\n  bool is_kinetic;\n  bool freeze_rotation;\n  int constraints;\n  int collision_detection_mode;\n  vector3_t center_of_mass;\n  vector3_t world_center_of_mass;\n  quaternion_t inertia_tensor_rotation;\n  vector3_t inertia_tensor;\n  bool detect_collisions;\n  vector3_t position;\n  quaternion_t rotation;\n  int interpolation;\n  int solver_iteration;\n  float sleep_threshold;\n  float max_angular_velocity;\n  int solver_velocity_iteration;\n};\n\nclass sprite_t\n{\npublic:\n  bool value_set;\n  const char *id;\n  float scale_x;\n  float scale_y;\n  int pivot_x;\n  int pivot_y;\n  bool update_collider;\n  float default_camera_size;\n  float default_camera_height;\n  float default_screen_height;\n  float default_atlas_size;\n};\n\nclass serialized_sprite_t\n{\npublic:\n  bool value_set;\n  const char *name;\n};\n\nclass game_object_t\n{\npublic:\n  int layer;\n  bool active_self;\n  bool is_static;\n  unsigned long long scene_culling_mask;\n  transform_t transform;\n  sphere_collider_t sphere_collider;\n  capsule_collider_t capsule_collider;\n  box_collider_t box_collider;\n  physic_material_t physic_material;\n  rigidbody_t rigidbody;\n  sprite_t sprite;\n  serialized_sprite_t serialized_sprite;\n  std::vector<game_object_t> children;\n};\n\nclass base_part_t\n{\npublic:\n  enum joint_type_t\n  {\n    fixed_joint = 0,\n    hinge_joint = 1\n  };\n\n  enum part_tier_t\n  {\n    regular = 0,\n    common = 1,\n    rare = 2,\n    epic = 3,\n    legendary = 4\n  };\n\n  enum part_type_t\n  {\n    unknown = 0,\n    balloon = 1,\n    balloons2 = 2,\n    balloons3 = 3,\n    // ... (rest of the enum values)\n    max = 50\n  };\n\n  enum auto_align_type_t\n  {\n    none = 0,\n    rotate = 1,\n    flip_vertically = 2\n  };\n\n  enum direction_t\n  {\n    right = 0,\n    up = 1,\n    left = 2,\n    down = 3,\n    up_right = 4,\n    up_left = 5,\n    down_left = 6,\n    down_right = 7\n  };\n\n  enum grid_rotation_t\n  {\n    deg_0 = 0,\n    deg_90 = 1,\n    deg_180 = 2,\n    deg_270 = 3,\n    deg_45 = 4,\n    deg_135 = 5,\n    deg_225 = 6,\n    deg_315 = 7,\n    deg_max = 8\n  };\n\n  enum joint_connection_type_t\n  {\n    none = 0,\n    source = 1,\n    target = 2\n  };\n\n  enum joint_connection_direction_t\n  {\n    any = 0,\n    right = 1,\n    up = 2,\n    left = 3,\n    down = 4,\n    left_and_right = 5,\n    up_and_down = 6,\n    none = 7\n  };\n\n  enum joint_connection_strength_t\n  {\n    weak = 0,\n    normal = 1,\n    high = 2,\n    extreme = 3,\n    highly_extreme = 4\n  };\n\n  bool m_eight_way;\n  int m_coord_x;\n  int m_coord_y;\n  float m_mass = 1.0f;\n  float m_interactive_radius = 0.5f;\n  float m_break_velocity;\n  float m_power_consumption;\n  float m_engine_power;\n  float m_z_offset;\n  int custom_part_index;\n  bool craftable = true;\n  bool loot_crate_reward = true;\n  int m_joint_type;\n  int m_part_tier;\n  int m_part_type;\n  int m_auto_align;\n  bool m_flipped;\n  int m_grid_rotation;\n  int m_grid_x_min;\n  int m_grid_x_max;\n  int m_grid_y_min;\n  int m_grid_y_max;\n  bool m_static;\n  int m_joint_connection_strength;\n  int m_joint_connection_type = joint_connection_type_t::target;\n  int m_joint_connection_direction;\n  int m_custom_joint_connection_direction = joint_connection_direction_t::none;\n  sprite_t sprite;\n  bool visible_on_part_list_before_unlocking;\n  bool joint_preprocessing;\n  int connected_component;\n  vector3_t wind_velocity;\n  bool valid;\n  int strict_connected_component;\n  int general_connected_component;\n  int generator_ref_count;\n  int generation_level;\n  int generation_index;\n  float temperature;\n  game_object_t game_object;\n};\n\nint main(void)\n{\n  std::vector<base_part_t> parts = {\n      ";
        string footer = "\n  };\n}";
        ...
        foreach (BasePart p in m_parts)
        {
            string TraverseGameObject(Transform t, int level = 0)
            {
                string objectString = "";
                GameObject g = t.gameObject;
                if (!g) return objectString;
                objectString += $"game_object_t{{{g.layer}, {(g.activeSelf ? "true" : "false")}, {(g.isStatic ? "true" : "false")}, {g.sceneCullingMask}, ";
                objectString += $"transform_t{{{{{t.localPosition.x}, {t.localPosition.y}, {t.localPosition.z}}}, {{{t.localRotation.x}, {t.localRotation.y}, {t.localRotation.z}, {t.localRotation.w}}}, {{{t.localScale.x}, {t.localScale.y}, {t.localScale.z}}}}}, ";
                SphereCollider sphereCollider = g.GetComponent<SphereCollider>();
                if (sphereCollider) objectString += $"sphere_collider_t{{true, {{{sphereCollider.center.x}, {sphereCollider.center.y}, {sphereCollider.center.z}}}, {sphereCollider.radius}}}, ";
                else objectString += "sphere_collider_t{false}, ";
                CapsuleCollider capsuleCollider = g.GetComponent<CapsuleCollider>();
                if (capsuleCollider) objectString += $"capsule_collider_t{{true, {{{capsuleCollider.center.x}, {capsuleCollider.center.y}, {capsuleCollider.center.z}}}, {capsuleCollider.radius}, {capsuleCollider.height}, {capsuleCollider.direction}}}, ";
                else objectString += "capsule_collider_t{false}, ";
                BoxCollider boxCollider = g.GetComponent<BoxCollider>();
                if (boxCollider) objectString += $"box_collider_t{{true, {{{boxCollider.center.x}, {boxCollider.center.y}, {boxCollider.center.z}}}, {{{boxCollider.size.x}, {boxCollider.size.y}, {boxCollider.size.z}}}}}, ";
                else objectString += "box_collider_t{false}, ";
                PhysicMaterial physicMaterial = g.GetComponent<PhysicMaterial>();
                if (physicMaterial) objectString += $"physic_material_t{{true, {physicMaterial.bounciness}, {physicMaterial.dynamicFriction}, {physicMaterial.staticFriction}, {(int)physicMaterial.frictionCombine}, {(int)physicMaterial.bounceCombine}}}, ";
                else objectString += "physic_material_t{false}, ";
                Rigidbody rigidbody = g.GetComponent<Rigidbody>();
                if (rigidbody) objectString += $"rigid_body_t{{true, {{{rigidbody.velocity.x}, {rigidbody.velocity.y}, {rigidbody.velocity.z}}}, {{{rigidbody.angularVelocity.x}, {rigidbody.angularVelocity.y}, {rigidbody.angularVelocity.z}}}, {rigidbody.drag}, {rigidbody.angularDrag}, {rigidbody.mass}, {(rigidbody.useGravity ? "true" : "false")}, {rigidbody.maxDepenetrationVelocity}, {(rigidbody.isKinematic ? "true" : "false")}, {(rigidbody.freezeRotation ? "true" : "false")}, {(int)rigidbody.constraints}, {(int)rigidbody.collisionDetectionMode}, {{{rigidbody.centerOfMass.x}, {rigidbody.centerOfMass.y}, {rigidbody.centerOfMass.z}}}, {{{rigidbody.worldCenterOfMass.x}, {rigidbody.worldCenterOfMass.y}, {rigidbody.worldCenterOfMass.z}}}, {{{rigidbody.inertiaTensorRotation.x}, {rigidbody.inertiaTensorRotation.y}, {rigidbody.inertiaTensorRotation.z}, {rigidbody.inertiaTensorRotation.w}}}, {{{rigidbody.inertiaTensor.x}, {rigidbody.inertiaTensor.y}, {rigidbody.inertiaTensor.z}}}, {(rigidbody.detectCollisions ? "true" : "false")}, {{{rigidbody.position.x}, {rigidbody.position.y}, {rigidbody.position.z}}}, {{{(int)rigidbody.interpolation}}}, {rigidbody.solverIterations}, {rigidbody.sleepThreshold}, {rigidbody.maxAngularVelocity}, {rigidbody.solverVelocityIterations}}}, ";
                else objectString += "rigidbody_t{false}, ";
                Sprite sprite = g.GetComponent<Sprite>();
                if (sprite) objectString += $"sprite_t{{true, \"{sprite.m_id}\", {sprite.m_scaleX}, {sprite.m_scaleY}, {sprite.m_pivotX}, {sprite.m_pivotY}, {(sprite.m_updateCollider ? "true" : "false")}, {Sprite.DefaultCameraSize}, {Sprite.DefaultCameraHeight}, {Sprite.DefaultScreenHeight}, {Sprite.DefaultAtlasSize}}}, ";
                else objectString += "sprite_t{false}, ";
                INSerializedSprite iNSerializedSprite = g.GetComponent<INSerializedSprite>();
                if (iNSerializedSprite) objectString += $"serialized_sprite_t{{true, \"{iNSerializedSprite.name}\"}}, ";
                else objectString += "serialized_sprite_t{false}, ";
                ...
                foreach (Transform child in t)
                {
                    ...
                    objectString += TraverseGameObject(child, level + 1);
                }
                objectString += $"}}}}";
                return objectString;
            }
            GameObject gameObject = p.gameObject;
            string partString = $"base_part_t{{{(p.m_eightWay ? "true" : "false")}, {p.m_coordX}, {p.m_coordY}, {p.m_mass}, {p.m_interactiveRadius}, {p.m_breakVelocity}, {p.m_powerConsumption}, {p.m_enginePower}, {p.m_ZOffset}, {p.customPartIndex}, {(p.craftable ? "true" : "false")}, {(p.lootCrateReward ? "true" : "false")}, {(int)p.m_jointType}, {(int)p.m_partTier}, {(int)p.m_partType}, {(int)p.m_autoAlign}, {(p.m_flipped ? "true" : "false")}, {(int)p.m_gridRotation}, {p.m_gridXmin}, {p.m_gridXmax}, {p.m_gridYmin}, {p.m_gridYmax}, {(p.m_static ? "true" : "false")}, {(int)p.m_jointConnectionStrength}, {(int)p.m_jointConnectionType}, {(int)p.m_jointConnectionDirection}, {(int)p.m_customJointConnectionDirection}, {{true, \"{p.m_constructionIconSprite.m_id}\", {p.m_constructionIconSprite.m_scaleX}, {p.m_constructionIconSprite.m_scaleY}, {p.m_constructionIconSprite.m_pivotX}, {p.m_constructionIconSprite.m_pivotY}, {(p.m_constructionIconSprite.m_updateCollider ? "true" : "false")}}}, {(p.VisibleOnPartListBeforeUnlocking ? "true" : "false")}, {(p.JointPreprocessing ? "true" : "false")}, {p.ConnectedComponent}, {{{p.WindVelocity.x}, {p.WindVelocity.y}, {p.WindVelocity.z}}}, {(p.valid ? "true" : "false")}, {p.StrictConnectedComponent}, {p.GeneralConnectedComponent}, {p.GeneratorRefCount}, {p.GenerationLevel}, {p.GenerationIndex}, {p.Temperature}, " + TraverseGameObject(p.gameObject.transform) + "},\n      ";
